...
@Component({
  selector: 'app-edit-banner-contacto',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './edit-banner-contacto.component.html',
  styleUrl: './edit-banner-contacto.component.css',
})
export class EditBannerContactoComponent implements OnInit {
  listCategories: any = [];
  files_date: any;
  submitted = false;
  data: any;
  ...
  valor_id_banner_contacto: any;
  post = new BannerContacto();
  constructor(
    private formBuilder: FormBuilder,
    private dataService: BannerContactoService,
  ...
  ngOnInit(): void {
    ...
    this.route.queryParams.subscribe((params) => {
      ...
      this.valor_id_banner_contacto = categoryId;
    });
  }
  ...
  onSubmit() {
    ...
    formData.append('id_banner_contacto', this.valor_id_banner_contacto);

    this.dataService.updateData(formData).subscribe((res) => {
      this.data = res;
      console.log(this.data);
      this.alerta();
      this.router.navigate(['/admin/banner/contacto']);
    });
  }
