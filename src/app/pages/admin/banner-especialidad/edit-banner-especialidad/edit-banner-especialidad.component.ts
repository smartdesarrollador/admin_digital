...
@Component({
  selector: 'app-edit-banner-especialidad',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './edit-banner-especialidad.component.html',
  styleUrl: './edit-banner-especialidad.component.css',
})
export class EditBannerEspecialidadComponent implements OnInit {
  listCategories: any = [];
  files_date: any;
  submitted = false;
  data: any;
  ...
  valor_id_banner_especialidad: any;
  post = new BannerEspecialidad();
  constructor(
    private formBuilder: FormBuilder,
    private dataService: BannerEspecialidadService,
  ...
  ngOnInit(): void {
    ...
    this.route.queryParams.subscribe((params) => {
      ...
      this.valor_id_banner_especialidad = categoryId;
    });
  }
  ...
  onSubmit() {
    ...
    formData.append(
      'id_banner_especialidad',
      this.valor_id_banner_especialidad
    );
    ...
    this.dataService.updateData(formData).subscribe((res) => {
      ...
      this.alerta();
      this.router.navigate(['/admin/banner/especialidad']);
    });
  }
