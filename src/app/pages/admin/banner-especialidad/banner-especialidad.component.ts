...
export class BannerEspecialidadComponent {
  listCategories: any = [];
  files_date: any;
  submitted = false;
  data: any;
  ...
  onEdit(category: BannerEspecialidad) {
    console.log(category);
    this.dataService.selectCategory = Object.assign({}, category);
    this.router.navigate(['/admin/banner/especialidad/edit'], {
      queryParams: { categoryId: category.id_banner_especialidad },
    });
  }
