...
@Component({
  selector: 'app-edit-banner-solucion',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './edit-banner-solucion.component.html',
  styleUrl: './edit-banner-solucion.component.css',
})
export class EditBannerSolucionComponent implements OnInit {
  listCategories: any = [];
  files_date: any;
  submitted = false;
  data: any;
  ...
  ngOnInit(): void {
    ...
    this.route.queryParams.subscribe((params) => {
      ...
      this.valor_id_banner_solucion = categoryId;
    });
  }
  ...
  onSubmit() {
    ...
    formData.append('id_banner_solucion', this.valor_id_banner_solucion);

    this.dataService.updateData(formData).subscribe((res) => {
      this.data = res;
      console.log(this.data);
      this.alerta();
      this.router.navigate(['/admin/banner/solucion']);
    });
  }
