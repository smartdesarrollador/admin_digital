...
export class BannerEventoComponent {
  listCategories: any = [];
  files_date: any;
  submitted = false;
  data: any;
  ...
  onEdit(category: BannerEvento) {
    console.log(category);
    this.dataService.selectCategory = Object.assign({}, category);
    this.router.navigate(['/admin/banner/evento/edit'], {
      queryParams: { categoryId: category.id_banner_evento },
    });
  }
