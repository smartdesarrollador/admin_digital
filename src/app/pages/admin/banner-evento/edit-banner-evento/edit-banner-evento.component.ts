...
@Component({
  selector: 'app-edit-banner-evento',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './edit-banner-evento.component.html',
  styleUrl: './edit-banner-evento.component.css',
})
export class EditBannerEventoComponent implements OnInit {
  listCategories: any = [];
  files_date: any;
  submitted = false;
  data: any;
  ...
  valor_id_banner_evento: any;
  post = new BannerEvento();
  constructor(
    private formBuilder: FormBuilder,
    private dataService: BannerEventoService,
  ...
  ngOnInit(): void {
    ...
    this.route.queryParams.subscribe((params) => {
      ...
      this.valor_id_banner_evento = categoryId;
    });
  }
  ...
  onSubmit() {
    ...
    formData.append('id_banner_evento', this.valor_id_banner_evento);

    this.dataService.updateData(formData).subscribe((res) => {
      this.data = res;
      console.log(this.data);
      this.alerta();
      this.router.navigate(['/admin/banner/evento']);
    });
  }
