...
@Component({
  ...
  styleUrl: './edit-solucion.component.css',
})
export class EditSolucionComponent {
  listCategories: any = [];
  files_date: any;
  submitted = false;
  data: any;
  ...
  valor_id_solucion: any;
  categoriaSolucionId: any = 1;
  ...
  ngOnInit(): void {
    ...
    this.route.queryParams.subscribe((params) => {
      ...
      this.valor_id_solucion = categoryId;
    });
  }
  ...
  createForm() {
    this.form = this.formBuilder.group({
      ...
      url: [this.dataService.selectCategory.url, Validators.required],
      image: [null],
    });
  }
  ...
  onSubmit() {
    ...
    formData.append('id_solucion', this.valor_id_solucion);
    ...
    this.dataService.updateData(formData).subscribe((res) => {
      ...
      this.alerta();
      this.router.navigate(['/admin/soluciones']);
    });
  }
