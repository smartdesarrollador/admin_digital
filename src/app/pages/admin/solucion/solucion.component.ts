...
export class SolucionComponent {
  ...
  onSubmit() {
    ...
    formData.append('nombre_solucion', this.files_date, this.files_date.name);
  ...
  onEdit(category: Solucion) {
    console.log(category);
    this.dataService.selectCategory = Object.assign({}, category);
    this.router.navigate(['/admin/soluciones/edit'], {
      queryParams: { categoryId: category.id_solucion },
    });
  }
