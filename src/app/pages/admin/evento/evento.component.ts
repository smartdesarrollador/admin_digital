...
export class EventoComponent {
  ...
  onSubmit() {
    ...
    formData.append('nombre_evento', this.files_date, this.files_date.name);
  ...
  onEdit(category: Evento) {
    console.log(category);
    this.dataService.selectCategory = Object.assign({}, category);
    this.router.navigate(['/admin/eventos/edit'], {
      queryParams: { categoryId: category.id_evento },
    });
  }
