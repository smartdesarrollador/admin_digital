...
@Component({
  selector: 'app-edit-banner-curso',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './edit-banner-curso.component.html',
  styleUrl: './edit-banner-curso.component.css',
})
export class EditBannerCursoComponent implements OnInit {
  listCategories: any = [];
  files_date: any;
  submitted = false;
  data: any;
  ...
  valor_id_banner_curso: any;
  post = new BannerCurso();
  constructor(
    private formBuilder: FormBuilder,
    private dataService: BannerCursoService,
  ...
  ngOnInit(): void {
    ...
    this.route.queryParams.subscribe((params) => {
      ...
      this.valor_id_banner_curso = categoryId;
    });
  }
  ...
  onSubmit() {
    ...
    formData.append('id_banner_curso', this.valor_id_banner_curso);

    this.dataService.updateData(formData).subscribe((res) => {
      this.data = res;
      console.log(this.data);
      this.alerta();
      this.router.navigate(['/admin/banner/curso']);
    });
  }
