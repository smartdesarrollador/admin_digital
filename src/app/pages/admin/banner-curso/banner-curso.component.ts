...
export class BannerCursoComponent {
  listCategories: any = [];
  files_date: any;
  submitted = false;
  data: any;
  ...
  onEdit(category: BannerCurso) {
    console.log(category);
    this.dataService.selectCategory = Object.assign({}, category);
    this.router.navigate(['/admin/banner/curso/edit'], {
      queryParams: { categoryId: category.id_banner_curso },
    });
  }
